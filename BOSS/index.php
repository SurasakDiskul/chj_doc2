...
<html lang="en">
   ...
   <?php 
    ...
    $res1 = mysqli_query($conn,"SELECT COUNT( doc_id ) FROM tbapproval where approver = '$membername'");
                     ...
                     <div class="row column_title">
                        <div class="col-md-12">
                           <div class="page_title">
                              <h2>Dashboard <span class="text-secondary">- BOARD OF DIRECTORS</span> </h2>
                           </div>
                        </div>
                     </div>
                           ...
                           <div class="full counter_section margin_bottom_30">
                              ...
                              <div class="counter_no">
                                 <div>
                                    ...
                                    <p class="head_couter">เอกสารรออนุมัติ</p>
                                 </div>
                              </div>
                           </div>
                        </div>
