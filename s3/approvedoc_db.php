<?php
    ...
    $approve3 = $_POST['approve3'];
        if($_POST['approve1'] == "$aa" && $_POST['appstatus1'] == 'Pending' && $_POST['approve2'] == "$ss" && $_POST['appstatus2'] == 'Pending' && $_POST['approve3'] == "$ss" && $_POST['appstatus3'] == 'Pending'){
            if($upload !='') {
           ...
           $sql9 = "UPDATE `tbappname` SET
            ...
            $sql12 = "SELECT * FROM `tbappname` WHERE docid = '".mysqli_real_escape_string($conn, $_POST['docid'])."' AND appstatus3 !=''";
            $result12 = mysqli_query($conn,$sql12);
            $row = mysqli_fetch_assoc($result14);
            if ($row['appstatus3'] == 'Approved') { 
                $sql50 = "DELETE FROM tbapproval WHERE doc_id = '".mysqli_real_escape_string($conn, $_POST['docid'])."' ";
                $result50 = mysqli_query($conn,$sql50);
                $sql51 = "UPDATE `tbdoc` SET
                    docstatus = '1',
                    docfile = '".$newname."'
                    WHERE docid = '".mysqli_real_escape_string($conn, $_POST['docid'])."'";
