              ...
              <div class="col-12 grid-margin">
                    <div class="table-responsive col-lg-12">
                        <?php 
                            ...
                            $sql = "SELECT * FROM `tbapproval` WHERE add_by = '$aa'";
                      ...
                      <thead class="thead-light">
                        ...
                        <?php while ($row = mysqli_fetch_assoc($result)) : ?>
                          ...
                          <td>
                           <a class="btn btn-warning btn-sm text-dark" href="approvedoc.php?doc_id=<?php echo $row['doc_id'] ?>">View</a>
                          </td>
                          </tr>
                          <?php endwhile; ?>
                        </tbody>
