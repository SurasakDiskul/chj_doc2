            ...
            <?php include ('./topbar.php') ?>
                           ...
                           <div class="white_shd full margin_bottom_30">
                              <div class="full graph_head">
                                 <div class="heading1 margin_0">
                                    <h2>เอกสารที่ไม่ผ่านการอนุมัติ</h2>
                                 </div>
                              </div>
              ...
              <div class="col-12 grid-margin">
                    <div class="table-responsive col-lg-12">
                        <?php 
                            $aa = $_SESSION['dename'];
                            $sql = "SELECT * FROM `tbdoc` WHERE docstatus = '2' and dename = '$aa'";
                      ...
                      <thead class="thead-light">
                          <tr>
                            ...
                            <th width="20%" class="text-danger"> ไฟล์เอกสาร </th>
                            <th width="20%" class="text-danger"> ส่งถึง </th>
                            <th width="10%" class="text-danger"> แผนก </th>
                        ...
                        <?php while ($row = mysqli_fetch_assoc($result)) : ?>
                          ...
                          <td>
                           <a class="btn btn-warning" href="viewrej.php?doc_id=<?php echo $row['docid'] ?>">View</a>
                          </td>
                          </tr>
                          <?php endwhile; ?>
                        </tbody>
