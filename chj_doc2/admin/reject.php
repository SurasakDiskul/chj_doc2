         ...
         <div class="inner_container">
            ...
            <?php include ('./topbar.php') ?>
              ...
              <div class="col-12 grid-margin">
                    <!--เปิดการใช้งาน Form-->
                    <form class="row gy-4" action="./reject_db.php" method="POST" enctype="multipart/form-data">
                            <div class="col-md-12">
                            ...
                            <div class="col-md-6">
                                ...
                                <a class="btn btn-info btn-sm" href="../doc_file/<?php echo $row['doc_file'];?>" target="_blank">ดูไฟล์เอกสาร</a>
                            ...
                            <input type="hidden" class="form-control " id="dename" name="dename" value="<?php echo $row['de_name'] ?>" readonly>
                           </div>
                        
                            <div class="col-md-12">
                                <label class="">หมายเหตุ</label>
                                <textarea name="remark" id="remark" class="form-control" rows="5" placeholder="**โปรดระบุ**"></textarea>
                            </div>
                            <div class="col-12">
                            <hr>
