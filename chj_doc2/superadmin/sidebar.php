               ...
               <div class="sidebar_blog_1">
                  ...
                  <div class="sidebar_user_info">
                     ...
                     <div class="user_profle_side">
                        ...
                        <div class="user_info">
                           <h6><?php echo $_SESSION['membername'];?></h6> <p class="text-secondary"><?php echo $_SESSION['status'];?></p>
                  ...
                  <ul class="list-unstyled components">
                     ...
                     <li>
                        ...
                        <ul class="collapse list-unstyled" id="element">
                           ...
                           <li><a href="./member.php">> <span>จัดการสมาชิก</span></a></li>
                           <li><a href="./department.php">> <span>รายชื่อแผนก</span></a></li>
                        </ul>
                     </li>
-->
                     <li><a href="./category.php"><i class="fa fa-table purple_color2"></i> <span>จัดการประเภทเอกสาร</span></a></li>
                     <li>
                        ...
                        <ul class="collapse list-unstyled" id="apps">
                           ...
                           <li><a href="approval.php">> <span>เอกสารรออนุมัติ</span></a></li>
                     ...
                     <li><a onclick="return confirm('คุณต้องการออกจากระบบใช่หรือไม่?')" href="../logout.php"><i class="fa fa-cog red_color"></i> <span>Logout</span></a></li>
                  </ul>
               </div>
            </nav>
            <!-- end sidebar -->