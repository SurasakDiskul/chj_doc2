...
$ss = $_GET['doc_id'];
$sql = "SELECT * FROM tbapproval WHERE doc_id = '$ss' and approver = '$aa'";
...
<script>
var pdf = new PDFAnnotate('pdf-container','<?php echo $aa ?>' , {
...
function savePDF() {
  pdf.savePdf("<?php echo $aa ?>"); // save with given file name
}
